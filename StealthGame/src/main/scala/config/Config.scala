...
/** Has the global configurations of the game, like the scene width and height,
  * width of buttons, of characters, etc.
  */
object Config:
  ...
  val SCENE_RIGHT_EDGE = SCENE_WIDTH / 2
  val SCENE_TOP_EDGE = SCENE_HEIGHT / 2
